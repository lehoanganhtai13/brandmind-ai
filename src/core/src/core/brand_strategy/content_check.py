...
PHASE_DELIVERABLE_SPECS: dict[str, str] = {
    ...
    "phase_4": (
        ...
        "3. Persuasion mechanics — 2-3 concrete F&B-specific mechanics "
        "that explain why the message should move a customer; named "
        "frameworks are optional and never enough by themselves\n"
        "4. Customer journey flow — distinct message angle for attention, "
        "interest, decision, and booking action tied to specific channels or "
        "content types; do not require named funnel jargon\n"
