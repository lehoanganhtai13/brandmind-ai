    ...
    subagents: list[dict[str, Any]] = [
        {
            ...
            "description": (
                ...
                "fresh external business research, or when one critical missing fact "
                "would change the strategy and cannot be resolved from the "
                "conversation or KG. Don't dispatch when "
                "the user has already provided competitor context and asks to "
                "search only if truly needed; "
                "synthesize that context in the main agent "
                "and name any evidence gaps instead. Don't dispatch "
                "for logo meaning, visual identity interpretation, feed/story/"
                "video quality, social content fit, or profile-level social "
                "audit; route those to social-media-analyst instead when "
                "current social/content evidence would change the decision. "
                "Don't dispatch for visual asset generation (creative-studio), "
                "deliverable assembly (document-generator), or strategy "
                "analysis already grounded in the conversation."
            ),
        ...
        },
        {
            ...
            "description": (
                ...
                "at profile/content depth: follower mix, content cadence, "
                "brand-voice tone, feed/story/video quality, content pillars, "
                "and audience-fit signals. Dispatch only when the user explicitly "
                "asks for current social/profile verification, or when a brand "
                "audit or positioning decision depends on current social, "
                "content, or visual evidence that cannot be answered from "
                "user-provided facts, KG, docs, or light search. "
                "Do not dispatch for strategic reasoning from "
                "first-party case facts or broad "
                "multi-channel competitive research; route broad business "
                "research to market-research instead. If live browser "
                "verification is authorized, the assignment must include "
                "LIVE_BROWSER_VERIFICATION_APPROVED; otherwise the social agent "
                "must use lightweight search/scrape or report the gap. Don't "
                "dispatch for generating new social content or visual assets "
                "(creative-studio for visuals)."
            ),
