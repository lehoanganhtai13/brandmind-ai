...
class TextIntegrityProcessor:
    ...
    It merges the fragmented text back to the previous page to ensure semantic
    continuity.
    """
    ...
    def _merge_text(self, current_content: str, next_content: str) -> Tuple[str, str]:
        ...
        # fragment comes from stripped_line, so we might need to
        # handle leading whitespace in paragraph_part
